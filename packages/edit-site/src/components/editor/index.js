...
import removePageContext from '../../utils/remove-page-context';
...
export default function Editor() {
	...
	const blockContext = useMemo(
		() =>
			addQueryContext(
				hasPageContentLock ? context : removePageContext( context ),
...
function addQueryContext( context, setContext ) {
	return {
		...context,
		queryContext: [
