...
export default function ContentFocusBreadcrumbs() {
	...
	return hasPageContentLock ? (
		<HStack
			className="edit-site-content-focus-breadcrumbs"
			expanded={ false }
			spacing={ 2 }
		>
			<Icon icon={ pageIcon } />
		...
		>
			<Button
				className="edit-site-content-focus-breadcrumbs__page-crumb"
				icon={ pageIcon }
			...
			<Icon
				className="edit-site-content-focus-breadcrumbs__chevron"
				icon={ chevronRightIcon }
				size={ 16 }
			/>
			<FlexItem className="edit-site-content-focus-breadcrumbs__template-crumb">
